...
public abstract class AbstractConfig {
    private Logger logger = LoggerFactory.getLogger(AbstractConfig.class);
    ...
    protected Properties readPropertiesFile(String filename, Boolean abortOnMissing) throws IOException {
        Properties p = null;
    ...
    protected MaxwellMysqlConfig parseMysqlConfig(String prefix, OptionSet options, Properties properties) throws Exception {
    ...
    private SSLMode getSslModeFromString(String sslMode) throws Exception {
        if (sslMode != null) {
            ...
            throw new Exception("Invalid binlog SSL mode string: " + sslMode);
        }
        return null;
    }
}
